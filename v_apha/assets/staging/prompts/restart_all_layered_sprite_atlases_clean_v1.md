...
- `docs/05_assets/asset-prompt-bible.md`
...
- corrugated cardboard edge treatment;
- matte painted-paper surfaces;
- restrained crayon texture;
- outline thickness;
...
- The object must look constructed from separately cut pieces of cardboard and
  painted paper.
- Corrugated tan edges must remain readable.
- Surfaces are matte.
- The illustration is slightly cartoon-like.
- Crayon and paint texture are visible but controlled.
- Shapes may have small handmade irregularities.
- Add restrained dirt, worn edges and glue marks.
- Each glued child piece casts a small local shadow on the layer beneath it.
