...
1. `00_project/project-vision.md`
2. `00_project/source-of-truth.md`
3. `02_creative/creative-direction.md`
4. `03_art/master-visual-style.md`
5. `03_art/art-bible.md`
6. `05_assets/technical-asset-contract.md`
7. `05_assets/asset-prompt-bible.md`
8. Approved Canon Assets in `05_assets/canon-asset-registry.md`
...
- Per-object prompt wording lives in `05_assets/asset-prompt-bible.md`.
