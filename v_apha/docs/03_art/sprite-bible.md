...
## Watchtower Layered Demo Baseline

The first validation artifact for this pipeline is:

- `assets/sprite-atlases/watchtower/layered-demo/watchtower_layered_demo_atlas.png`
- `assets/sprite-atlases/watchtower/layered-demo/watchtower_layered_demo_manifest.json`
- `assets/sprite-atlases/watchtower/layered-demo/watchtower_layered_demo_review_grid.png`
- `assets/sprite-atlases/watchtower/layered-demo/watchtower_layered_demo_composite_preview.png`

This demo is the format baseline, not final art approval for every future object. Future objects should match the same layered structure while improving painted detail through object-specific generation.

## Source Material

Derived from `../05_assets/asset-prompt-bible.md`, current assets, and atlas tooling.
