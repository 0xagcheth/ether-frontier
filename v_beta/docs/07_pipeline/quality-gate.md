...
- Layered cardboard has visible fine paper-fiber texture on exposed and printed
  faces; the print does not erase the substrate.
- Solid punchboard edges are visible without corrugated flutes.
- Any plastic, foam, rubber, vector-flat, or textureless 3D-token read is an
  automatic blocking failure.
