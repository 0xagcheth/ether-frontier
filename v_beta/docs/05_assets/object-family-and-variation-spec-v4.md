...
> **SUPERSEDED FOR OBJECT IDENTITY.** Canonical Seven-Circles family structure
> is in `object-family-and-variation-spec-v5.md`. V4 may be consulted only for
> compatible technical animation/anchor details.
