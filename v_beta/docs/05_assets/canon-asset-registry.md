...
| Canon Psoglav Runner | Lower City beast body/scale/motion reference | MISSING | `assets/approved/canon/enemies/fast_walk_front.png` | Required before enemy batch production. |
