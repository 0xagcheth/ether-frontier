...
|---|---:|---|
| Camera / Projection | below 10 | Runtime objects must be true top-down orthographic 90°. Gameplay-board concepts use 80–90° overhead. Narrative concepts are never geometry references. No isometric, 3/4 side-view or facade. |
...
| Faction Identity | below 10 | Guardians, Children of the Lower Serpent, Grey, damaged Nav, captured construction, neutral and UI identities must not mix incorrectly. |
