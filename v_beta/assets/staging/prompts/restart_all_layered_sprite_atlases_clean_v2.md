# Ether Frontier — Seven Circles clean restart of all layered sprite atlases v2

> **SUPERSEDED / DO NOT RUN (2026-07-26).** Technical pipeline ideas remain
> useful, but object identity and abilities must be rebuilt from
...
- `docs/02_creative/game-lore-bible-v6.md`
- `docs/01_design/game-system-and-lore-integration-v1.md`
- `docs/02_creative/faction-bible-v5.md`
- `docs/02_creative/character-bible-v5.md`
- `docs/02_creative/entity-mechanics-codex-v5.md`
- `docs/02_creative/object-renaming-map-v3.md`
- `docs/05_assets/object-lore-material-overlay-v5.md`
- `docs/05_assets/asset-prompt-bible-v6.md`
- `docs/05_assets/production-prompt-catalog-v1.md`
- `docs/05_assets/object-family-and-variation-spec-v5.md`
- `docs/05_assets/restart-description-driven-object-pipeline-v3.md`
- `docs/05_assets/modular-object-family-plan.md`
- `docs/05_assets/object-module-registry-v2.json`
- `docs/05_assets/watchtower-layer-contract-v4.md` (Watchtower stage only)
- `docs/03_art/master-visual-style.md`
- `docs/03_art/sprite-bible.md`

When documentation conflicts, use this priority:

1. `game-lore-bible-v6.md`
2. `game-system-and-lore-integration-v1.md`
3. `entity-mechanics-codex-v5.md`
4. `asset-prompt-bible-v6.md`
5. `production-prompt-catalog-v1.md` for per-family source wording
6. `object-family-and-variation-spec-v5.md` for mechanical construction
7. `restart-description-driven-object-pipeline-v3.md`
8. `modular-object-family-plan.md`
9. `object-module-registry-v2.json`
10. art and sprite guides
11. gameplay code

Old generated assets and archives never override the documentation.

## Canon lock — Seven Circles of Iriy / Seven Roads of the Last Knot

- Option C is the only lore canon.
- Never blend Options A or B into prompts.
- No Kitezh-17, secret laboratory, reality-editing archive, archive stamp,
  facility inventory mark or controlling wooden-tablet code.
- Soviet and post-Soviet influence appears only through visual memory:
  monumental rhythm, mosaic composition, engineering clarity, print
  registration and cosmic optimism.
- Every object declares its gameplay function, material obligation and at most
  one campaign Road source.
- Identity is expressed through construction, material process and unique
  mechanism, not through a carpet of symbols.
- Seven Roads are an original coalition, not a universal ancient doctrine.
- Yav/Nav/Prav terminology belongs only to a contested in-world school.
- Daariya is never presented as confirmed neutral history.
- Runtime IDs remain stable; display names come from
  `object-renaming-map-v3.md`.
- Any pre-v5 projection master is technical history, not a lore reference.

## Generation model

Use built-in **ImageGen 2** for every artistic raster source. Do not silently
substitute manual raster drawing, SVG, another image model or legacy art.
Deterministic code remains allowed for chroma removal, masks, tight cropping,
atlas packing, manifests, pivots, review grids and technical QA.

If ImageGen is temporarily unavailable, pause raster generation and continue
documentation or deterministic technical work. Never fabricate a replacement
production image.
...
The primary gameplay mechanism receives deliberate cartoon exaggeration:

- 15–30% larger than a neutral physical proportion when needed for runtime
  readability;
- strongest local contrast and saturation;
- stable base remains quieter;
- exaggeration must not make the object resemble a heavier specialization.
